...
public:
	...
	MINISCRIPT_MINISCRIPT_STATIC_DLL_IMPEXT static const string HTTP_METHOD_GET;
	MINISCRIPT_MINISCRIPT_STATIC_DLL_IMPEXT static const string HTTP_METHOD_HEAD;
	MINISCRIPT_MINISCRIPT_STATIC_DLL_IMPEXT static const string HTTP_METHOD_POST;
	MINISCRIPT_MINISCRIPT_STATIC_DLL_IMPEXT static const string HTTP_METHOD_PUT;
	MINISCRIPT_MINISCRIPT_STATIC_DLL_IMPEXT static const string HTTP_METHOD_DELETE;
